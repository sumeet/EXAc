...
" Language keywords
syntax keyword excKeywords feof fread fdrop fseek fcreate fcreate_then_wipe fwrite fvoid kill HALT link const spawn chready wait chtoggle fopen chignore hostid repeat
