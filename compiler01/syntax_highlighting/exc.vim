...
" Language keywords
syntax keyword excKeywords feof fread fdrop fseek fcreate fwrite kill HALT link const spawn chready wait chtoggle fopen loop chignore hostid continue repeat
